...
import es.uca.iw.esijob.domain.PuestoDataOnDemand;
...
privileged aspect PuestoDataOnDemand_Roo_DataOnDemand {
    ...
    public void PuestoDataOnDemand.setIddemandante(Puesto obj, int index) {
        Demandante iddemandante = demandanteDataOnDemand.getRandomDemandante();
        obj.setIddemandante(iddemandante);
    }
    
    public void PuestoDataOnDemand.setIdoferta(Puesto obj, int index) {
