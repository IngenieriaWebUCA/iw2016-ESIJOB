...
import es.uca.iw.esijob.web.FormacionController;
...
privileged aspect FormacionController_Roo_Controller {
    ...
    public String FormacionController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String FormacionController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Formacion.findFormacion(id));
        return "formacions/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String FormacionController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
