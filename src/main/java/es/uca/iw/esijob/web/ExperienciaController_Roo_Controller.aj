...
privileged aspect ExperienciaController_Roo_Controller {
    ...
    public String ExperienciaController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String ExperienciaController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Experiencia.findExperiencia(id));
        return "experiencias/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ExperienciaController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
